"""
Django settings for test_app1_3 project.
...
WSGI_APPLICATION = 'test_app1_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_app1_3 API",
    "DESCRIPTION": "API documentation for test_app1_3 App",
    "VERSION": "v1",
}
